...
public class IntegratedServerListenThreadMixin {
    @WrapOperation(method = "func_71755_c", at = @At(value = "INVOKE", target = "Ljava/net/InetAddress;getLocalHost()Ljava/net/InetAddress;"))
    private InetAddress fml$useCustomLocalHost(Operation<InetAddress> original) {
        return null;
    }

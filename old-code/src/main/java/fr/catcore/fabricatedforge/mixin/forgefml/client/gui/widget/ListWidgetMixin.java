...
public abstract class ListWidgetMixin /*implements IListWidget*/ {
    ...
    public void drawContainerBackground(Tessellator tess) {
        ...
        tess.begin();
        tess.color(2105376);
        tess.vertex((double)this.field_1250, (double)this.yEnd, 0.0, (double)((float)this.field_1250 / height), (double)((float)(this.yEnd + (int)this.scrollAmount) / height));
        tess.vertex((double)this.xEnd, (double)this.yEnd, 0.0, (double)((float)this.xEnd / height), (double)((float)(this.yEnd + (int)this.scrollAmount) / height));
        tess.vertex((double)this.xEnd, (double)this.yStart, 0.0, (double)((float)this.xEnd / height), (double)((float)(this.yStart + (int)this.scrollAmount) / height));
        tess.vertex((double)this.field_1250, (double)this.yStart, 0.0, (double)((float)this.field_1250 / height), (double)((float)(this.yStart + (int)this.scrollAmount) / height));
        tess.end();
    }
}

...
public class LogTable {
    ...
    private static final int[] exp_2_table = new int[]{
            32768,
            32945,
            33124,
            33304,
    ...
    public static int log_2(int x) {
        ...
        return 32768 * shift + eval_table(log_2_table, x - 32768);
    }

    public static int raise_2(int x) {
        int y = eval_table(exp_2_table, x & 32767) << 15;
        return y >> 15 - (x >> 15);
    }

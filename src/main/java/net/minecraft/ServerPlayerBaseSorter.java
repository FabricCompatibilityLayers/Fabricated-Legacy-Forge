...
public final class ServerPlayerBaseSorter implements Comparator<String> {
    ...
    public ServerPlayerBaseSorter(List<String> list, Map<String, String[]> map, Map<String, String[]> map2, String string) {
        this.list = list;
    ...
    private Set<String> build(String string, Set<String> set, String string2) {
        ...
        if (var4 == null) {
            ...
            while(var5.hasNext()) {
                ...
                if (var6 == string2) {
                    throw new UnsupportedOperationException("Can not sort ServerPlayerBase classes for method '" + this.methodName + "'. Circular superiosity found including '" + string2 + "'");
                }

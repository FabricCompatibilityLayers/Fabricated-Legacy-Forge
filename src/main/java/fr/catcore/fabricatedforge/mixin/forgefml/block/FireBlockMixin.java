...
public abstract class FireBlockMixin extends Block implements IFireBlock {
    ...
    public void onTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (par1World.getGameRules().getBoolean("doFireTick")) {
            ...
            if (var6
                    || !par1World.isRaining()
                    || !par1World.isBeingRainedOn(par2, par3, par4)
                    && !par1World.isBeingRainedOn(par2 - 1, par3, par4)
                    && !par1World.isBeingRainedOn(par2 + 1, par3, par4)
                    && !par1World.isBeingRainedOn(par2, par3, par4 - 1)
                    && !par1World.isBeingRainedOn(par2, par3, par4 + 1)) {
                                ...
                                if (var10 != par2 || var12 != par3 || var11 != par4) {
                                    ...
                                    if (var14 > 0) {
                                        ...
                                        if (var15 > 0
                                                ...
                                                && (!par1World.isRaining() || !par1World.isBeingRainedOn(var10, var12, var11))
                                                && !par1World.isBeingRainedOn(var10 - 1, var12, par4)
                                                && !par1World.isBeingRainedOn(var10 + 1, var12, var11)
                                                && !par1World.isBeingRainedOn(var10, var12, var11 - 1)
                                                && !par1World.isBeingRainedOn(var10, var12, var11 + 1)) {

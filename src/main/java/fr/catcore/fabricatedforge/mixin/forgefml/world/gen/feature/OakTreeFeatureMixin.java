                ...
                for(var10 = par3 - var13; var10 <= par3 + var13 && var7; ++var10) {
                    for(var11 = par5 - var13; var11 <= par5 + var13 && var7; ++var11) {
                        if (var8 >= 0 && var8 < 128) {
                            ...
                            if (var12 != 0 && Block.BLOCKS[var12] != null && !((IBlock)Block.BLOCKS[var12]).isLeaves(par1World, var10, var8, var11)) {
            ...
            if (!var7) {
                ...
                if ((var8 == Block.GRASS_BLOCK.id || var8 == Block.DIRT.id) && par4 < 128 - var6 - 1) {
                    ...
                    for(var16 = 0; var16 < var6; ++var16) {
                        ...
                        if (var10 == 0 || block != null && ((IBlock)block).isLeaves(par1World, par3, par4 + var16, par5) || var10 == Block.field_334.id || var10 == Block.WATER.id) {
                    ...
                    for(var16 = par4 - 3 + var6; var16 <= par4 + var6; ++var16) {
                        ...
                        for(var12 = par3 - var11; var12 <= par3 + var11; ++var12) {
                            for(var13 = par5 - var11; var13 <= par5 + var11; ++var13) {
                                ...
                                if (block != null && ((IBlock)block).isLeaves(par1World, var12, var16, var13)) {

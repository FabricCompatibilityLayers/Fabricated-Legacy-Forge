...
public abstract class AttachedStemBlockMixin extends FlowerBlock implements IBlock {
        ...
        if (par1World.method_3720(par2, par3 + 1, par4) >= 9) {
            ...
            if (par5Random.nextInt((int)(25.0F / var6) + 1) == 0) {
                ...
                if (var7 < 7) {
                    ...
                    boolean isSoil = BLOCKS[var11] != null && ((IBlock)BLOCKS[var11]).canSustainPlant(par1World, var9, par3 - 1, var10, ForgeDirection.UP, (IPlantable) this);

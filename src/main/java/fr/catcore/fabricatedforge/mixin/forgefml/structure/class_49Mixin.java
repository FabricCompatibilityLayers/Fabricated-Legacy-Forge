...
public abstract class class_49Mixin extends class_53 {
    ...
    public boolean generate(World par1World, Random par2Random, BlockBox par3StructureBoundingBox) {
        ...
        if (!this.field_91) {
            int var4 = this.applyYTransform(1);
            int var5 = this.applyXTransform(5, 5);
        ...
        for(int var8 = 0; var8 < 7; ++var8) {
            for(int var5 = 0; var5 < 10; ++var5) {
                this.clearBlocksUpwards(par1World, var5, 6, var8, par3StructureBoundingBox);
                this.method_72(par1World, Block.STONE_BRICKS.id, 0, var5, -1, var8, par3StructureBoundingBox);
            }
        }

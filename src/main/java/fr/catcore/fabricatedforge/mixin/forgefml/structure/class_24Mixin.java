        ...
        if (this.isTouchingLiquid(par1World, par3StructureBoundingBox)) {
            ...
            switch (this.field_47) {
                ...
                case 2:
                    ...
                    for(var4 = 1; var4 <= 9; ++var4) {
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, var4, 3, 1, par3StructureBoundingBox);
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, var4, 3, 9, par3StructureBoundingBox);
                    }
                    ...
                    for(var4 = 1; var4 <= 3; ++var4) {
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, 4, var4, 4, par3StructureBoundingBox);
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, 6, var4, 4, par3StructureBoundingBox);
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, 4, var4, 6, par3StructureBoundingBox);
                        this.method_56(par1World, Block.STONE_BRICKS.id, 0, 6, var4, 6, par3StructureBoundingBox);
                    }

                    this.method_56(par1World, Block.TORCH.id, 0, 5, 3, 5, par3StructureBoundingBox);

                    for(var4 = 2; var4 <= 8; ++var4) {
                        this.method_56(par1World, Block.PLANKS.id, 0, 2, 3, var4, par3StructureBoundingBox);
                        this.method_56(par1World, Block.PLANKS.id, 0, 3, 3, var4, par3StructureBoundingBox);
                        if (var4 <= 3 || var4 >= 7) {
                            this.method_56(par1World, Block.PLANKS.id, 0, 4, 3, var4, par3StructureBoundingBox);
                            this.method_56(par1World, Block.PLANKS.id, 0, 5, 3, var4, par3StructureBoundingBox);
                            this.method_56(par1World, Block.PLANKS.id, 0, 6, 3, var4, par3StructureBoundingBox);
                        }

                        this.method_56(par1World, Block.PLANKS.id, 0, 7, 3, var4, par3StructureBoundingBox);
                        this.method_56(par1World, Block.PLANKS.id, 0, 8, 3, var4, par3StructureBoundingBox);
                    }
                    ...
                    this.method_69(par1World, par3StructureBoundingBox, par2Random, 3, 4, 8, ChestGenHooks.getItems("strongholdCrossing"), ChestGenHooks.getCount("strongholdCrossing", par2Random));
            }

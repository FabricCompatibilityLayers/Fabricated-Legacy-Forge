...
public interface IPlayerAPIClientPlayerEntity {
    PlayerBase getPlayerBase(String string);

    Set<String> getPlayerBaseIds(String string);
    ...
    void localAddMovementStat(double d, double e, double f);

    void superAddStat(Stat arg, int i);

    void localAddStat(Stat arg, int i);
    ...
    void localAlertWolves(MobEntity arg, boolean bl);
    ...
    void localDisplayGUIBrewingStand(BrewingStandBlockEntity arg);
    ...
    void localDisplayGUIEditSign(SignBlockEntity arg);

    void superDisplayGUIEnchantment(int i, int j, int k);

    void localDisplayGUIEnchantment(int i, int j, int k);
    ...
    ItemEntity localDropPlayerItemWithRandomChoice(ItemStack arg, boolean bl);
    ...
    double localGetDistanceSqToEntity(Entity arg);
    ...
    int localGetItemIcon(ItemStack arg, int i);
    ...
    void localKnockBack(Entity arg, int i, double d, double e);
    ...
    void localSetPositionAndRotation(double d, double e, double f, float g, float h);

    CanSleepEnum superSleepInBedAt(int i, int j, int k);

    CanSleepEnum localSleepInBedAt(int i, int j, int k);
    ...
    boolean realIsBlockTranslucent(int i, int j, int k);
    ...
    SmoothUtil getField_71160_ciField();

    void setField_71160_ciField(SmoothUtil arg);

    SmoothUtil getField_71161_cjField();

    void setField_71161_cjField(SmoothUtil arg);

    SmoothUtil getField_71162_chField();

    void setField_71162_chField(SmoothUtil arg);
    ...
    void setMcField(Minecraft minecraft);
    ...
    void setSprintToggleTimerField(int i);

...
public class VersionRange {
        ...
        while(true) {
            ...
            do {
                do {
                    ...
                    version = (ArtifactVersion)i$.next();
                } while(!this.containsVersion(version));
            } while(matched != null && version.compareTo(matched) <= 0);
    ...
    public boolean containsVersion(ArtifactVersion version) {
        ...
        } while(!restriction.containsVersion(version));

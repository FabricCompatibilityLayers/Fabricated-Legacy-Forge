...
//        this.classLoader = FabricLauncherBase.getLauncher().getTargetClassLoader();
    ...
    private File computeExistingClientHome() {
        ...
        if (str != null) {
            ...
            ReflectionHelper.setPrivateValue(mcMaster, null, new File(str), new String[]{"minecraftDir", "am"});
        }
        ...
        return (File)ReflectionHelper.getPrivateValue(mcMaster, null, new String[]{"minecraftDir", "am"});
    }

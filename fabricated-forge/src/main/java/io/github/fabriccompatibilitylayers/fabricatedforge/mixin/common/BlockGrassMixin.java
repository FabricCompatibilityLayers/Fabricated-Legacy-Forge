...
public abstract class BlockGrassMixin extends Block implements BlockExtension {
    ...
    private int forge$getBlockLightOpacity1(int[] array, int index, Operation<Integer> original,
    ...
    private int forge$getBlockLightOpacity2(int[] array, int index, Operation<Integer> original,
                                            @Local(argsOnly = true) World par1World,
                                            @Local(ordinal = 4) int var7,
                                            @Local(ordinal = 5) int var8,
                                            @Local(ordinal = 6) int var9) {

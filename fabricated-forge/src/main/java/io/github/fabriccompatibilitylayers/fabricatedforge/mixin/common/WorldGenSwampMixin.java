...
public class WorldGenSwampMixin {
    ...
    private int forge$isLeaves2(World instance, int par2, int par3, int i, Operation<Integer> original) {
        int blockId = original.call(instance, par2, par3, i);
        Block block = Block.blocksList[blockId];
        return block != null && ((BlockExtension) block).isLeaves(instance, par2, par3, i) ? Block.leaves.blockID : 0;
    }
}
